  ...
  return (
    <div className="w-full bg-transparent font-sans md:px-10">
      <div className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-background border border-border flex items-center justify-center z-10">
        ...
        {/* Static Timeline Line - Full Height */}
        <div className="absolute md:left-8 left-8 top-0 bottom-0 w-[2px] bg-gradient-to-b from-transparent via-border to-transparent">
          {/* Colored line overlay - static */}
