  ...
  return (
    <div className="w-full bg-transparent font-sans md:px-10">
      <div className="relative max-w-7xl mx-auto pb-20">
        ...
        {/* Timeline line */}
        <div 
          className="absolute md:left-8 left-8 top-0 bottom-0 w-0.5 bg-linear-to-b from-transparent via-border to-transparent"
          role="presentation"
          aria-hidden="true"
        >
          <div className="absolute inset-x-0 top-0 bottom-0 w-0.5 bg-linear-to-b from-purple-500 via-blue-500 to-transparent opacity-60" />
        </div>
      </div>
    </div>
  );
